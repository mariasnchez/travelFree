...
class Hotel extends Model
{
    ...
    protected $fillable = ['nombre', 'direccion', 'descripcion', 'valoracion', 'valUbi', 'valLim', 'valSer', 'valCalPre', 'foto1', 'foto2', 'foto3', 'foto4', 'foto5', 'foto6', 'idCiudad'];
    ...
    {
        return $this->belongsToMany('App\Models\User', 'hotel_visitado', 'idHotel', 'idUsu')
