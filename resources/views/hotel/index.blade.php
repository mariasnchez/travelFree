                        ...
                        <div class="bg-white rounded-md p-4 h-56 md:h-40 flex relative">
                            <div class="flex flex-col flex-grow">
                                <a class="cursor-pointer hover:font-bold hover:underline"
                                    ...
                                    <p class=" text-base md:text-xl uppercase">{{ $numeroHotel }}.
                                        {{ $hotel->nombre }}
                                    </p>
                                </a>
                            ...
                            <div class="flex flex-col-reverse">
                                <div class="md:mr-4">
                                    @if ($hotel->ofertas->count() > 0)
                                        <div class="bg-cyan-500 text-white text-right p-2 w-fit translationText"
                                            data-translation-key="disponible">Oferta disponible</div>
                                    @endif
                                </div>
                            ...
                            <img src="{{ $hotel->foto1 }}" alt="Imagen 1"
                                class="hidden md:block ml-auto h-40 -mt-4 -mr-4">
