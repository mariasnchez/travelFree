...
<body>
    <div class="contenedor">
        ...
        <div id="bg-video">
            ...
            <h1 id="titulo">
                TravelFree
                <svg width="25.30757mm" height="25.30757mm" viewBox="0 0 158.30757 158.30757" version="1.1"
                    id="svg5" xml:space="preserve" inkscape:version="1.2.2 (732a01da63, 2022-12-09)"
                    ...
                    <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1"
                        ...
                        <path sodipodi:type="spiral"
                            ...
                            sodipodi:cx="53.897205" sodipodi:cy="92.34137" sodipodi:expansion="1"
                ...
                <a href="/hotelDetallado?query={{ $oferta->hotel->nombre }}">
                    <div id="oferta">
                        ...
                        <div id="precio">
                            ...
                            <p id="precioOfer">{{ $oferta->precioOferta }}€</p>
                        </div>
                    </div>
                </a>
            @endforeach
