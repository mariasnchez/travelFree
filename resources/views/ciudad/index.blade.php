...
<body class="bg-[#ECECEC] mb-10">
    <div class="contenedor">
        ...
        <div class="grid place-items-center h-60 bg-image bg-cover">
            ...
            <h1 class="absolute text-5xl mt-4 font-bold text-white md:text-6xl lg:text-7xl xl:text-9xl">
        ...
        <div class="flex items-center justify-center mt-6 mb-10">
            <div class="relative bg-white rounded-md w-44 mx-2 hover:bg-slate-100 ">
                <a href="hotel?query={{ $query }}"
                    ...
                    <span class="text-base font-bold translationText uppercase"
                        data-translation-key="hoteles">HOTELES</span>
                </a>
            </div>
            <div class="relative bg-white rounded-md w-44 mx-2 hover:bg-slate-100 ">
                <a href="restaurante?query={{ $query }}"
                    ...
                    <p class="text-base font-bold translationText uppercase" data-translation-key="restaurantes">
                        RESTAURANTES</p>
                </a>
            </div>
        </div>
        ...
        <div class="flex items-center m-10 text-black text-4xl uppercase">
            <h1 class="translationText font-bold" data-translation-key="destacadasHot">Hoteles destacados</h1>
        </div>
        ...
        <div class="flex items-center m-10 text-black text-4xl uppercase">
            <h1 class="translationText font-bold" data-translation-key="destacadasRes">Restaurantes destacados</h1>
        </div>
