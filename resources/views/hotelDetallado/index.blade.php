        ...
        <div class="w-2/4 p-4  bg-white mr-10 ">
            ...
            @if ($numeroComentarios == 0)
                ...
                <div class="text-xl mt-4">
                    <p class="py-4 mx-4"><progress class="custom-progress mr-1" value="{{ $hotel->valUbi }}"
                            max="10"></progress>
                        {{ $hotel->valUbi }} · Ubicación</p>
                    <p class="py-4 mx-4"><progress class="custom-progress mr-1" value="{{ $hotel->valLim }}"
                            max="10"></progress>
                        {{ $hotel->valLim }} · Limpieza</p>
                    <p class="py-4 mx-4"><progress class="custom-progress mr-1" value="{{ $hotel->valSer }}"
                            max="10"></progress>
                        {{ $hotel->valSer }} · Servicio</p>
                    <p class="py-4 mx-4"><progress class="custom-progress mr-1" value="{{ $hotel->valCalPre }}"
                            max="10"></progress>
                        {{ $hotel->valCalPre }} · Calidad-Precio
                    </p>
                </div>
            @else
                <div class="ml-4">
