                ...
                <div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex justify-center">
                            <x-text-input id="email" class="email-input block mt-1 w-full pl-14 translationText"
                                type="email" name="email" :value="old('email')" required autofocus
                                autocomplete="username" data-translation-key="email" placeholder="Correo electrónico" />
                        </div>
                        ...
                        <div class="mt-4 flex justify-center">
                            <x-text-input id="password" class="pass-input block mt-1 w-full pl-14 translationText"
                                type="password" name="password" required autocomplete="current-password"
                                data-translation-key="pass" placeholder="Contraseña" />
