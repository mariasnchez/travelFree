...
<body class="bg-[#ECECEC]">
    <div class="m-10">
        ...
        <div class=" mt-6 text-black">
            <a href="/users/restaurantes" class="text-lg hover:underline"><img class="inline-block w-5 mr-2"
                    src="{{ URL::asset('img/volver.svg') }}" />Volver</a>
        </div>
        <div class="container m-10 mt-3">
            <div class="text-4xl text-[#727272] mb-10 text-center">
                <p>Editar el restaurante nº {{ $restaurante->idRes }}</p>
            </div>
                ...
                <div class="m-10">
                    ...
                    <div class="container mx-auto px-4">
                        <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg">
                            <div class="p-6">
                                <form action="{{ route('users.restaurante.update', $restaurante->idRes) }}"
                                    method="POST">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="mb-4">
                                        <label for="telefono" class="block uppercase font-bold mb-1">Teléfono</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="tipoCocina" class="block uppercase font-bold mb-1">Tipo
                                            cocina</label>
                                        <input type="text" name="tipoCocina" id="tipoCocina"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="descripcion" id="descripcion"
                                            class="w-full border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring focus:border-blue-500">{{ $restaurante->descripcion }}</textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="foto1" class="block uppercase font-bold mb-1">Foto 1</label>
                                        <input type="text" name="foto1" id="foto1"
                                            value="{{ $restaurante->foto1 }}"
                                            class="w-full border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring focus:border-blue-500">
                                    </div>
