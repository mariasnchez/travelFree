    ...
    <div class="m-10">
        ...
        <div class="container m-10 mt-3">
            <div class="text-4xl text-[#727272] mb-10 text-center">
                <p>Editar el hotel nº {{ $hotel->idHotel }}</p>
            </div>
                ...
                <div class="m-10">
                    ...
                    <div class="container mx-auto px-4">
                        <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg">
                            <div class="p-6">
                                <form action="{{ route('users.hotel.update', $hotel->idHotel) }}"
                                    method="POST">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="descripcion" id="descripcion"
                                            class="w-full border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring focus:border-blue-500">{{ $hotel->descripcion }}</textarea>
                                    </div>
