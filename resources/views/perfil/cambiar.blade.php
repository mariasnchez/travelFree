                                    ...
                                    <form action="{{ route('actualizar') }}" method="POST">
                                        ...
                                        <div class="mb-4">
                                            <label for="contrasena_actual"
                                                ...
                                                data-translation-key="passNow">Contraseña
                                                actual</label>
                                        ...
                                        <div class="mb-4">
                                            <label for="nueva_contrasena"
                                                class="block uppercase font-bold mb-1 translationText"
                                                data-translation-key="nuevaCon">Nueva
                                                contraseña</label>
                                        ...
                                        <div class="mb-4">
                                            <label for="nueva_contrasena_confirmation"
                                                class="block uppercase font-bold mb-1 translationText"
                                                data-translation-key="confNuevaCo">Confirmar nueva contraseña</label>
                                        ...
                                        <button type="submit"
                                            ...
                                            data-translation-key="actualizar">Actualizar
                                            contraseña</button>
                                    </form>
