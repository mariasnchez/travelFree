            ...
            <div class="container lg:m-10 mt-10">
                ...
                <div class="mt-10 text-black">
                    <div class="flex justify-between items-center">
                        <h1 class="text-3xl sm:text-4xl uppercase translationText" data-translation-key="tuPerfil">Tu
                            perfil
                        </h1>
                ...
                <div class="mt-4">
                    <div class="text-lg sm:text-xl grid grid-cols-1 gap-2 relative">
                        ...
                        <p class="w-1/3 pb-3 border-b border-slate-600"><img class="inline-block w-10 mr-2"
                            ...
                            {{ $user->email }}</p>
                        <div class="mt-2 ">
                            <span class="translationText" data-translation-key="numHot">Número de hoteles
                                visitados:</span>
                            <span>{{ $hoteles->count() }}</span>
                            <br>
                            <span class="translationText" data-translation-key="numRes">Número de restaurantes
                                visitados:</span>
                            <span>{{ $restaurantes->count() }}</span>
                        </div>
