...
<body class="bg-[#ECECEC]">
    ...
    <div class="grid place-items-center bg-cyan-700">
        ...
        <div class="grid place-items-end bg-white mb-10 rounded-lg bg-cyan-50">
            <a href="{{ URL::to('destinos/create') }}" class="hover:text-zinc-600 mr-10 mt-3 mb-3 "> Nuevo destino <img
                    class="inline-block w-8 " src="{{ URL::asset('img/mas.png') }}"></a>
            <table class="text-center mb-10 ml-10 mr-10">
                <thead class="border border-gray-400">
                    <tr>
                        ...
                        <th class="border border-gray-400 px-4 py-2"><img class="w-8"
                                src="{{ URL::asset('img/editar.png') }}" alt=""></th>
                        <th class="border border-gray-400 px-4 py-2"><img class="w-8"
                                src="{{ URL::asset('img/eliminar.png') }}" alt=""></th>
                    </tr>
                </thead>
                        ...
                        <tr class="border border-gray-400">
                            ...
                            <td>
                                ...
                                <form action="{{ route('destinos.destroy', $destino->id) }}" method="POST">
                                    <a class="text-teal-600 hover:text-teal-800 font-bold"
                                        href="{{ route('destinos.edit', $destino->id) }}"> Editar</a>

                                    @csrf
                                    @method('DELETE')
                            <td> <button type="submit" class="text-red-500 hover:text-red-800 font-bold">
                                    Borrar</button> </td>
                            </form>
